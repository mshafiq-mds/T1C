<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Prodata.WebForm.AssetWriteOff.Approver.Default" %>
    ...
    <div class="card shadow-sm border-0 mt-4">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <asp:DropDownList ID="ddlStatusFilter" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlStatusFilter_SelectedIndexChanged">
                        <asp:ListItem Text="Pending Action" Value="Pending" Selected="True"></asp:ListItem>
        ...
        <div class="card-body p-0">
            <asp:GridView ID="gvRequests" runat="server" CssClass="table table-hover table-striped align-middle mb-0" 
                AutoGenerateColumns="False" GridLines="None" EmptyDataText="No requests found for the selected status."
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Highest Value (RM)">
                        <ItemStyle CssClass="text-right fw-bold text-primary" />
                        <ItemTemplate>

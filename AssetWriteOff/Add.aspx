<%@ Page Title="New Asset Write-Off" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Prodata.WebForm.AssetWriteOff.Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        // --- NEW STRICT SWEETALERT VALIDATION ---
        function beforeSubmit() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                //const remarks = rows[i].querySelector('textarea[name="Remarks"]').value.trim();

                // Check if ANY text box or date picker in the row is empty
                ...
                // Ensure Original Price is higher than 0
                if (parseFloatSafe(orig) <= 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Invalid Amount',
                        text: `Original Price must be greater than RM 0.00 on Row ${rowNum}.`
                    });
                    return false;
                }
            }

            // 3. Validate Master Bottom Fields
            if (justification === "") {
            ...
            if (documentUpload === "") {
                Swal.fire({ icon: 'warning', title: 'Missing Document', text: 'Please upload a supporting document (PDF, Image, etc.).' });
                return false;
            }

            // If ALL validation passes, show loader and submit to C# Backend
        ...
        <asp:Panel runat="server" CssClass="card card-custom">
            ...
            <div class="card-header card-header-sticky d-flex align-items-center position-sticky top-0" style="z-index: 1000; width: 100%;">
                <h3 class="card-title m-0 fw-bold text-dark">
                    <i class="fas fa-minus-circle mr-2 text-danger"></i><%: Page.Title %>
                </h3>
                
                <div class="card-tools" style="margin-left: auto !important;">
                    <asp:LinkButton ID="btnBack" runat="server" CssClass="btn btn-outline-secondary mr-2" PostBackUrl="~/AssetWriteOff/Default" CausesValidation="false">
            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <asp:TextBox runat="server" ID="txtRequestNo" CssClass="form-control txtreadonly font-weight-bold text-primary" placeholder="Auto-generated" />
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <small class="text-muted d-block mb-2">Upload approvals, inspection reports, or related photos.</small>
                    </div>
                </div>

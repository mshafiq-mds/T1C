<%@ Page Title="Edit Cummulative Approver" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CumEdit.aspx.cs" Inherits="Prodata.WebForm.MasterData.AdditionalBudgetApprover.CumEdit" %>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group row">
                                <asp:Label ID="lblMinValue" runat="server" AssociatedControlID="txtMinValue" CssClass="col-md-3 col-form-label text-md-right" Text="Cummulative"></asp:Label>
                                <div class="col-md-7">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">RM</span>
                                        </div>
                                        <asp:TextBox ID="txtMinValue" runat="server" CssClass="form-control input-number2" placeholder="Cummulative"></asp:TextBox>
                                    </div>
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtMinValue" CssClass="text-danger" Display="Dynamic" ErrorMessage="Cummulative is required"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group row">

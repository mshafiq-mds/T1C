<%@ Page Title="Add AWO Approver" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Prodata.WebForm.MasterData.AOW.Add" %>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header card-header-custom d-flex align-items-center">
                    <h3 class="card-title m-0 fw-bold text-dark">
                        <i class="fas fa-plus-circle mr-2 text-primary"></i><%: Page.Title %>
                    </h3>
                    <div class="card-tools" style="margin-left: auto !important;">
                        ...
                        <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-success" OnClick="btnSave_Click" OnClientClick="return validateForm();">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info py-2 small mb-4">
                        <i class="fas fa-info-circle"></i> Define the minimum and maximum amount threshold, and the order (level) in which the approval occurs. Leave Max Amount blank if there is no upper limit.
                    </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Action Type <span class="asterisk">*</span></label>
                             <asp:TextBox ID="txtActionType" runat="server" CssClass="form-control"  placeholder="Approver"></asp:TextBox> 
                        </div>
                    </div>

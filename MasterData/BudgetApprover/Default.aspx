<%@ Page Title="Budget Approver" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Prodata.WebForm.MasterData.BudgetApprover.Default" %>
                                        ...
                                        <asp:GridView ID="gvBudgetApprover" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-sm" PageSize='<%# FGV.Prodata.App.Setting.RecordsPerPage() %>' AllowPaging="true" OnPageIndexChanging="gvBudgetApprover_PageIndexChanging" EmptyDataText="No record.">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-info btn-xs" OnClick="btnEdit_Click" Visible='<%# Prodata.WebForm.Auth.Can(Prodata.WebForm.Auth.Id(), "budget-approver-edit") %>'>
                                                            <i class="fas fa-edit"></i>
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-danger btn-xs button-delete" data-id='<%# Eval("Id") %>' Visible='<%# Prodata.WebForm.Auth.Can(Prodata.WebForm.Auth.Id(), "budget-approver-delete") %>'>

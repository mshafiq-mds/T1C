<%@ Page Title="Add User" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Prodata.WebForm.Administration.User.Add" %>
                                        ...
                                        <div class="tab-pane fade show active" id="detail-tab-content" role="tabpanel" aria-labelledby="detail-tab">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <asp:Label ID="lblPassword" runat="server" AssociatedControlID="txtPassword" CssClass="col-md-4 col-form-label text-md-right" Text="Password"></asp:Label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <asp:Label ID="lblConfirmPassword" runat="server" AssociatedControlID="txtConfirmPassword" CssClass="col-md-4 col-form-label text-md-right" Text="Password Confirmation" />
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" placeholder="Password Confirmation" TextMode="Password" />

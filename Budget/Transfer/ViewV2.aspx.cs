...
{
    public partial class ViewV2 : ProdataPage
    {
        ...
        private void LoadTransferMasterAndDetails(Guid id)
        {
            using (var db = new AppDbContext())
            {
                ...
                lblDate.Text = transfer.Date.ToString("dd-MMM-yyyy"); // Better display format for View
                lblEstimatedCost.Text = "RM " + transfer.EstimatedCost.ToString("N2");
                lblEVisa.Text = transfer.EVisaNo;
                lblWorkDetails.Text = transfer.WorkDetails;
                ...
                if (documents.Any())
                {
                    ...
                    foreach (var doc in documents)
                    {
                        ...
                        var link = new HyperLink
                        {
                            ...
                            CssClass = "btn btn-sm btn-outline-success mr-2 d-print-none", // Hide button when printing
                            Target = "_blank",

        ...
        <asp:Panel ID="pnlPrintArea" runat="server" CssClass="card card-custom page-break-inside-avoid">
            ...
            <div class="card-header card-header-sticky d-flex align-items-center">
                ...
                <div class="card-tools" style="margin-left: auto !important;">
                    <asp:LinkButton ID="btnBack" runat="server" CssClass="btn btn-outline-secondary mr-2" PostBackUrl="~/Budget/Transfer/TransferApplication/Default" CausesValidation="false">
            ...
            <div class="card-body p-4">
                ...
                <h4 class="section-title mt-4">Budget Flow Details</h4>

        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:Label runat="server" ID="ddFromBA"  ></asp:Label>
                ...
                <tr>
                    ...
                    <td><asp:Label runat="server" ID="txtToBudgetType" CssClass="form-control txtreadonly" placeholder="Example: 55200060" /></td> 
                    <td>
                        <asp:Label runat="server" ID="ddToBA" CssClass="form-control fixed-dropdown select2 txtreadonly" data-placeholder="BA" ></asp:Label>

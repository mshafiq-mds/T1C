<%@ Page Title="Transfer Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewV2.aspx.cs" Inherits="Prodata.WebForm.Budget.Transfer.ViewV2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        @media print {
            ...
            /* Break panels to avoid splitting in half */
            .page-break-inside-avoid { page-break-inside: avoid; }
        }
    </style>

    <div class="full-screen-container">
        <asp:Panel ID="pnlPrintArea" runat="server" CssClass="card card-custom">

            <div class="card-header card-header-sticky d-flex align-items-center position-sticky top-0" style="z-index: 1000; width: 100%;">
                <h3 class="card-title m-0 fw-bold text-dark"><i class="fas fa-file-invoice-dollar mr-2"></i><%: Page.Title %></h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Label ID="lblRefNo" runat="server" CssClass="view-data text-primary" />
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">E-VISA No.</label>
                        <asp:Label ID="lblEVisa" runat="server" CssClass="view-data text-info" />
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:Label ID="lblWorkDetails" runat="server" CssClass="view-data" />
                    </div>
                </div>

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtPONumber" runat="server" CssClass="form-control" placeholder="e.g. 102938" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPONumber" CssClass="text-danger" Display="Dynamic" ErrorMessage="Please enter PO Number"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div id="allocationDropdownSection" runat="server" class="form-group d-none">
                                                ...
                                                <div class="mt-2" id="divAddAllocationBtn" runat="server"><button type="button" class="btn btn-info btn-sm" id="btnAddAllocation"><i class="fa fa-plus"></i> Add Allocation Row</button></div>

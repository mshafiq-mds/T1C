<%@ Page Title="New Budget T1C" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Addv2.aspx.cs" Inherits="Prodata.WebForm.T1C.Addv2" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <asp:PlaceHolder ID="phDataCost" runat="server">
                                <div class="form-group row">
                                    <asp:Label ID="lblDataKos" runat="server" CssClass="col-lg-2 col-sm-3 col-form-label" AssociatedControlID="txtCurrentYearActualYTD" Text="Data Cost"></asp:Label>
                                    <div class="col-lg-8 col-sm-7 mb-3">
                                        ...
                                        <table style="width: 100%;">
                                            <tbody>
                                                <tr>
                                                    <th class="text-center align-middle pl-2 pr-1" data-bs-toggle="tooltip" title="Annual Budget Balance...">A <i class="fas fa-info-circle text-muted ms-1"></i></th>
                                                    <td><asp:TextBox ID="txtA" runat="server" CssClass="form-control input-number2"></asp:TextBox></td>
                                                    <th class="text-center align-middle pl-2 pr-1" data-bs-toggle="tooltip" title="Work Order...">C <i class="fas fa-info-circle text-muted ms-1"></i></th>
                                                    <td><asp:TextBox ID="txtC" runat="server" CssClass="form-control input-number2"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <th class="text-center align-middle pl-2 pr-1" data-bs-toggle="tooltip" title="Final Repair Date...">B <i class="fas fa-info-circle text-muted ms-1"></i></th>
                                                    <td><asp:TextBox ID="txtB" runat="server" CssClass="form-control"></asp:TextBox></td>
                                                    <th class="text-center align-middle pl-2 pr-1" data-bs-toggle="tooltip" title="RFS/RFQ...">D <i class="fas fa-info-circle text-muted ms-1"></i></th>

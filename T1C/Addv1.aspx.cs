...
namespace Prodata.WebForm.T1C
{
    ...
    {
        protected string BudgetsJson { get; set; }
        ...
        private void BindYearDropdown()
        {
            ...
            ddlYear.Items.Add(new ListItem((currentYear + 1).ToString(), (currentYear + 1).ToString()));
        ...
        private void LoadAllocations()
        {
            ...
            {
                btnSelectAllocations.Enabled = true; // enable button

                Guid selectedGuid;
                int selectedYear;

                if (Guid.TryParse(ddlBT.SelectedValue, out selectedGuid) && int.TryParse(ddlYear.SelectedValue, out selectedYear))
                {
                    ...
                    BudgetsJson = Newtonsoft.Json.JsonConvert.SerializeObject(budgets);
                }
                else
                {
            ...
            {
                btnSelectAllocations.Enabled = false; // disable button
                BudgetsJson = "[]";
            }
        }
...
//                Guid selectedGuid;
//                if (Guid.TryParse(ddlBT.SelectedValue, out selectedGuid))
//                {
//                    var budgets = new Class.Budget().GetBudgets(
//                        typeId: selectedGuid,
...
//                else
//                {
//                    // not a valid Guid, disable button just in case
//                    btnSelectAllocations.Enabled = false;
//                }
//            }
//            else

<%@ Page Title="T1C Others Approval" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Prodata.WebForm.T1C.PoolBudget.Approval.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="printArea">
        ...
        <div class="print-header d-none">
            ...
            <h3 class="mt-2">T1C Others Budget Approval List</h3>
                                            ...
                                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered" PageSize='<%# FGV.Prodata.App.Setting.RecordsPerPage() %>' AllowPaging="true" OnPageIndexChanging="gvData_PageIndexChanging" EmptyDataText="No record.">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" CssClass="btn btn-outline-info btn-xs" PostBackUrl='<%# $"~/T1C/PoolBudget/Approval/Edit?Id={Eval("Id")}" %>'>
                                                            ...
                                                            <asp:LinkButton runat="server"
                                                                ...
                                                                PostBackUrl='<%# (bool)Eval("IsPendingUserAction") ? $"~/T1C/PoolBudget/Approval/Edit?Id={Eval("Id")}" : "#" %>'
